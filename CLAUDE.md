...
This project is indexed by GitNexus as **chatbasket_backend** (3554 symbols, 8863 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

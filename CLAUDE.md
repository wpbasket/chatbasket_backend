...
This project is indexed by GitNexus as **chatbasket_backend** (5003 symbols, 12043 relationships, 272 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

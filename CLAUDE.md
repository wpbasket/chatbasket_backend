...
This project is indexed by GitNexus as **chatbasket_backend** (3741 symbols, 9482 relationships, 284 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

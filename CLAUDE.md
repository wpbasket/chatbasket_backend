...
This project is indexed by GitNexus as **chatbasket_backend** (3194 symbols, 8381 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

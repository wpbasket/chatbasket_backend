...
This project is indexed by GitNexus as **chatbasket_backend** (3600 symbols, 9035 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

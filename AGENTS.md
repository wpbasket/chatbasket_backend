...
This project is indexed by GitNexus as **chatbasket_backend** (3735 symbols, 9372 relationships, 281 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

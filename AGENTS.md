...
This project is indexed by GitNexus as **chatbasket_backend** (3011 symbols, 7620 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **chatbasket_backend** (2917 symbols, 7301 relationships, 246 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

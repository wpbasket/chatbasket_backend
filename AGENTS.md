...
This project is indexed by GitNexus as **chatbasket_backend** (3222 symbols, 8461 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

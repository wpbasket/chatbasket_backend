...
This project is indexed by GitNexus as **chatbasket_backend** (3825 symbols, 9897 relationships, 287 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

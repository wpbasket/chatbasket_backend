...
This project is indexed by GitNexus as **chatbasket_backend** (2841 symbols, 8602 relationships, 163 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **chatbasket_backend** (5830 symbols, 13575 relationships, 285 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
